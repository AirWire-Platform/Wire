...
int64_t GetSporkValue(int nSporkID)
{
    ...
    if (mapSporksActive.count(nSporkID)) {
        ...
        if (nSporkID == SPORK_17_MINSTAKE_ENFORCEMENT) r = SPORK_17_MINSTAKE_ENFORCEMENT_DEFAULT;
...
int CSporkManager::GetSporkIDByName(std::string strName)
{
    ...
    if (strName == "SPORK_17_MINSTAKE_ENFORCEMENT") return SPORK_17_MINSTAKE_ENFORCEMENT;
...
std::string CSporkManager::GetSporkNameByID(int id)
{
    ...
    if (id == SPORK_17_MINSTAKE_ENFORCEMENT) return "SPORK_17_MINSTAKE_ENFORCEMENT";
